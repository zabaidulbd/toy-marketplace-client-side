        ...
        <>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p><span className="text-xl ms-3">Lego-Store</span><br /><span>Kamal Ataturk Road, Dhaka-1212</span></p>

                </div>
                <div>
                    <h2 className="font-bold text-3xl ps-5">Contact</h2>
                    <p className="text-xl">Phone: 002-6598562</p>
                    <p className="text-xl">email: lego@gmail.com</p>
