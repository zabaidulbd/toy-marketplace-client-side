...
const AllToys = () => {
    ...
    return (
        <div>
            <Navbar></Navbar>
            <h1 className='font-bold text-5xl text-center mt-10 mb-20 text-orange-400'> List of All Toys</h1>
            ...
            <div className="overflow-x-auto">
                <table className="table table-compact w-full text-orange-400 mb-10">
                    <thead>
                        <tr>
                            <th>Seller-Name</th>
                            <th>Toy-Name</th>
