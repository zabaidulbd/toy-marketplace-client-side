            ...
            <div className="carousel w-full rounded-lg">
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <div className="absolute bottom-72 left-96">
                        <h2 className='text-5xl text-orange-400'>Lego Cars</h2>
                        <p className='text-orange-400 py-5'>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
